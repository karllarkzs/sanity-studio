...
class DocumentTypeListBuilder extends _DocumentList.DocumentListBuilder {
  ...
  cloneWithoutDefaultIntentHandler(withSpec) {
    ...
    var shouldOverride = canHandleIntent && canHandleIntent.identity === _documentTypeListItems.DEFAULT_INTENT_HANDLER;
    var override = shouldOverride ? {
      canHandleIntent: undefined
    } : {};
    builder.spec = _objectSpread({}, this.spec, {}, withSpec || {}, {}, override);
    return builder;
  }
